...
class DefaultAsyncWaitStrategyFactory implements AsyncWaitStrategyFactory {
    ...
    private final PropertyKeys.DisruptorProperties disruptorProps;

    public DefaultAsyncWaitStrategyFactory(final PropertyKeys.DisruptorProperties disruptorProps) {
