...
import static org.apache.logging.log4j.util.LoaderUtil.newInstanceOfUnchecked;
...
import org.apache.logging.log4j.core.impl.PropertyKeys.Logger;
import org.apache.logging.log4j.core.impl.PropertyKeys.LoggerContext;
import org.apache.logging.log4j.core.impl.PropertyKeys.StatusLogger;
import org.apache.logging.log4j.core.impl.PropertyKeys.ThreadContext;
...
public class Log4jInstanceFactoryPostProcessor implements ConfigurableInstanceFactoryPostProcessor {
    ...
    private <T> void registerIfPresent(
        ...
        if (serviceImplementation != null) {
            instanceFactory.registerBinding(forClass(serviceType), () -> newInstanceOfUnchecked(serviceImplementation));
        }
    }
}
