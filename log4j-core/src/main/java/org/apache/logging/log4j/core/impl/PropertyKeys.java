...
public final class PropertyKeys {
    ...
    public record Configuration(
            ...
            @Nullable String reliabilityStrategy,
    ...
    @Log4jProperty
    public record GC(
            @Log4jProperty(defaultValue = "4096") int encoderByteBufferSize,
    ...
    @Log4jProperty
    public record StatusLogger(@Nullable Level defaultStatusLevel) {}
    ...
    public record ThreadContext(
            ...
            boolean garbageFree,
            @Nullable Class<? extends ThreadContextMap> mapClass) {}
